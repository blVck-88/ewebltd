      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          <div className="space-y-4">
            <Link to="/" className="inline-block">
              <img src="/images/logo.svg" alt="East Wed Logo" className="h-10 w-auto mb-4" />
            </Link>
            <p className="text-sm leading-relaxed">Creating unforgettable wedding experiences since 2010. We turn your dream wedding into reality with our expert planning and execution.</p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm">
              <p className="flex items-start">
                ...
                123 Wedding Street<br/>New York, NY 10001
              </p>
          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col space-y-3">
              ...
              <p className="text-xs text-gray-500">Get updates about our latest wedding trends and offers.</p>
            </form>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-sm text-gray-500">&copy; {new Date().getFullYear()} East Wed. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
